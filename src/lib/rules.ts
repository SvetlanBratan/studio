...
export const RACES: Race[] = [
    ...
    { name: 'Проклятые', passiveBonuses: ['Скверна (противник теряет 5 ОМ)', 'Холод утраты (-5 урона от атак света)'], activeAbilities: [{ name: 'Вторая фаза', description: 'Наносит 60 урона и накладывает эффект тления.', cost: { om: 40 } }] },
