...
export const RACES: Race[] = [
    ...
    { name: 'Антаресы', passiveBonuses: ['Исцеление (+10 ОЗ каждый ход)', 'Проницательность (-5 урона от любого источника)'], activeAbilities: [{ name: 'Самоисцеление', description: 'Восстанавливает +50 ОЗ.', cost: {om: 30} }] },
    ...
    { name: 'Астролоиды', passiveBonuses: ['Звёздный резонанс (+10 ОМ каждый ход)', 'Понимание звёзд (-5 урона от стихий света и эфира)'], activeAbilities: [{ name: 'Метеорит', description: 'наносит 60 урона.', cooldown: 3, cost: {om: 40}} ] },
    ...
    { name: 'Вансаэльцы', passiveBonuses: ['Истинное благородство (-5 урона от любых способностей, если ОЗ выше 150)', 'Этикет крови (+1 ОМ в начале каждого хода)'], activeAbilities: [{ name: 'Приказ крови', description: 'наносит 30 урона.', cost: {om: 20} }] },
    { name: 'Василиски', passiveBonuses: ['Иммунитет к яду', 'Изворотливость (-10 урона от всех атак)'], activeAbilities: [{ name: 'Окаменяющий взгляд', description: 'лишает противника одного действия.', cost: {om: 30} }] },
    ...
    { name: 'Гуриты', passiveBonuses: ['Глубокая регенерация (+10 ОЗ каждый ход)', 'Токсины слизи (наносит эффект отравления)'], activeAbilities: [{ name: 'Щупальца глубин', description: 'лишают врага одного действия и наносят 30 урона.', cost: {om: 30} }] },
    { name: 'Дарнатиаре', passiveBonuses: ['Кристальная стабильность (+10 ОМ в начале каждого хода)', 'Магический резонанс (-5 урона от заклинаний)'], activeAbilities: [{ name: 'Разлом ауры', description: 'наносит 50 урона.', cost: { om: 30 } }] },
    { name: 'Джакали', passiveBonuses: ['Аура благословения (+5 ОЗ в начале каждого хода)', 'Чуткий слух (-10 урона от атак, связанных со звуком или воздушной магией)'], activeAbilities: [{ name: 'Глас богов', description: 'наносит 35 урона и восстанавливает +15 ОЗ.', cost: { om: 30 } }] },
    ...
    { name: 'Домовые', passiveBonuses: ['Сила очага (+10 ОЗ каждый ход, если не был получен урон в предыдущем)', 'Щепетильный нюх (-5 урона от яда)'], activeAbilities: [{ name: 'Очистка', description: 'снимает все негативные эффекты и восстанавливает +30 ОЗ.', cost: { om: 30 } }] },
    ...
    { name: 'Дриады', passiveBonuses: ['Единение с природой (+10 ОМ каждый ход)', 'Хрупкость (+10 к получаемому урону от огня и льда)'], activeAbilities: [{ name: 'Удушающее плетение', description: 'наносит 40 урона и лишает врага одного действия.', cost: { om: 30 } }] },
    ...
    { name: 'Духи', passiveBonuses: ['Слияние со стихией (+5 ОМ каждый ход)', 'Сопротивление воздействию (-20 урона от стихий)'], activeAbilities: [{ name: 'Эхо мира духов', description: 'наносит 50 урона эфиром.', cost: { om: 40 } }] },
    { name: 'Друиды', passiveBonuses: ['Друидическая связь (+10 ОМ каждый ход)', 'Мелодия исцеления (+5 ОЗ каждый ход)'], activeAbilities: [{ name: 'Песня стихий', description: 'наносит 45 урона или восстанавливает 45 ОЗ (на выбор при применении).', cost: { om: 30 } }] },
    { name: 'Инсектоиды', passiveBonuses: ['Живучесть (+5 ОЗ каждый ход)', 'Насекомая стойкость (-5 урона от физических атак)'], activeAbilities: [{ name: 'Кислотное жало', description: 'наносит 50 урона.', cost: { om: 30 } }] },
    ...
    { name: 'Коралиты', passiveBonuses: ['Венец жизни (-5 урона от атак, если ОЗ выше 150)', 'Предчувствие (+3 ОЗ в начале каждого хода)'], activeAbilities: [{ name: 'Коралловый плевок', description: 'наносит 45 урона.', cost: {om: 30} }] },
    ...
    { name: 'Кунари', passiveBonuses: ['Светлая душа (-10 урона от магии эфира, света и иллюзий)', 'Живая защита (+5 ОЗ каждый ход, если враг использует стихийные атаки)'], activeAbilities: [{ name: 'Природное возрождение', description: 'восстанавливает +60 ОЗ.', cost: {om: 30} }] },
    ...
    { name: 'Миканиды', passiveBonuses: ['Грибница (+10 ОЗ каждый ход)', 'Споры (противник получает -10 урона при следующей атаке)'], activeAbilities: [{ name: 'Споровый взрыв', description: 'наносит 40 урона и ослабляет врага (-10 урона следующей атаке).', cost: {om: 30} }] },
    { name: 'Мириоды', passiveBonuses: ['Хитиновый покров (-10 урона от физических атак)', 'Боль превращения (+10 урона)'], activeAbilities: [{ name: 'Смертельный рывок', description: 'наносит 60 урона.', cost: {om: 40} }] },
    { name: 'Нарраторы', passiveBonuses: ['Повесть боли (если Нарратор теряет более 30 ОЗ за ход, восстанавливает 10 ОМ)', 'Истинное слово (-5 урона от заклинаний)'], activeAbilities: [{ name: 'Конец главы', description: 'наносит 50 урона и накладывает эффект удержания', cost: {om: 50} }] },
    ...
    { name: 'Тритоны', passiveBonuses: ['Водная адаптация (-10 урона от атак воды и холода)', 'Холодный ум (+5 ОМ в начале каждого хода)'], activeAbilities: [{ name: 'Всплеск', description: 'наносит 40 урона себе и врагу 50, и снижает инициативу врага (-30 ОД)', cost: { om: 30 } }] },
    ...
    { name: 'Химеры', passiveBonuses: ['Ипостась силы (-10 урона от физических атак)', 'Адаптация (восстанавливают +10 ОЗ, если урон превысил 40 за ход)'], activeAbilities: [{ name: 'Переворот', description: 'наносит 40 урона и лишает врага одного действия.', cost: { om: 40 } }] },
    ...
    { name: 'Ятанаги', passiveBonuses: ['Эфирная стабильность (+10 ОМ каждый ход)', 'Магическое тело (-5 урона от всех атак, если текущий ОМ выше 50)'], activeAbilities: [{ name: 'Поток стихий', description: 'наносит 60 урона (эфир).', cost: { om: 40 } }] },
];
...
export const getActionLabel = (type: ActionType, payload?: any): string => {
  ...
  if (type === 'move' && payload?.distance) {
    return `${label}: ${payload.distance}м`;
  }
