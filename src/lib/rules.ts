...
export const RACES: Race[] = [
    ...
    { name: 'Коралиты', passiveBonuses: ['Венец жизни (-5 урон от атак, если ОЗ выше 150)', 'Предчувствие (+3 ОЗ/ход)'], activeAbilities: [{ name: 'Коралловый плевок', description: 'Наносит 45 урона.', cost: {om: 30} }] },
    { name: 'Кордеи', passiveBonuses: ['Прочная шкура (-5 физ. урон)', 'Уязвимость к свету и огню (+10 урона)'], activeAbilities: [{ name: 'Кровавая печать', description: 'Наносит 55 урона.', cost: {om: 30} }] },
    ...
    { name: 'Оборотни', passiveBonuses: ['Инстинкт (-10 от этого урона)', 'Взрыв ярости (+10 урона)'], activeAbilities: [{ name: 'Полный Зверь', description: 'Наносит 50 урона.', cost: { om: 30 } }] },
    { name: 'Огненные крыланы (Фениксы)', passiveBonuses: ['Теплокровность (+50 иммунитет к огню)', 'Перерождение (+50 ОЗ при ОЗ < 30)'], activeAbilities: [{ name: 'Крылья пламени', description: 'Наносят 60 урона огнём.', cost: { om: 40 } }] },
    ...
    { name: 'Полукоты', passiveBonuses: ['Девять жизней (+50 ОЗ при ОЗ < 10)', 'Уверенность в прыжке (+10 к физическим атакам)'], activeAbilities: [{ name: 'Когти судьбы', description: 'Наносит 40 урона.', cost: { om: 30 } }] },
    { name: 'Полузаи', passiveBonuses: ['Усиленный слух (-5 урона от звуковых атак)', 'Воздушное ускорение (-5 ОД на перемещение)'], activeAbilities: [{ name: 'Вихрь эфира', description: 'Накладывает эффект удержания.', cost: { om: 30 } }] },
