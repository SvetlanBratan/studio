...
export const RACES: Race[] = [
    ...
    { name: 'Арахнии', passiveBonuses: [], activeAbilities: [{ name: 'Паутина', description: 'замедление врага', cost: {od: 10, om: 10} }] },
    ...
    { name: 'Безликие', passiveBonuses: ['Отражает весь урон'], activeAbilities: [{ name: 'Пронзающий удар', description: '+20 ОЗ физурона', cost: {od: 30} }] },
    { name: 'Белояры', passiveBonuses: [], activeAbilities: [{ name: 'Песня влюблённого', description: '-10 ОЗ врагу, +10 ОЗ себе', cost: {om: 30} }] },
    ...
    { name: 'Вансаэльцы', passiveBonuses: [], activeAbilities: [{ name: 'Обратиться к духам', description: 'призыв духа-хранителя', cost: {om: 90} }] },
    { name: 'Василиски', passiveBonuses: ['Иммунитет к ядам'], activeAbilities: [{ name: 'Окаменение взглядом', description: 'враг теряет ход', cooldown: 5, cost: {om: 90} }] },
    { name: 'Веспы', passiveBonuses: [], activeAbilities: [{ name: 'Вспышка зрения', description: 'ослепление на 1 ход', cost: {om: 10} }] },
    { name: 'Вулгары', passiveBonuses: ['Иммунитет к болезням', '+10 ОМ/ход'], activeAbilities: [{ name: 'Удар подавления', description: 'снижает ОМ врага на 15', cost: {om: 10} }] },
    { name: 'Гуриты', passiveBonuses: [], activeAbilities: [{ name: 'Обволакивающая слизь', description: 'замедление врага', cost: {om: 10} }] },
    { name: 'Дарнатиаре', passiveBonuses: [], activeAbilities: [{ name: 'Целительный ветер', description: '+15 ОЗ союзнику', cost: {om: 30} }] },
    ...
    { name: 'Драконы', passiveBonuses: ['+50 ОЗ', '+10 ОМ/ход'], activeAbilities: [{ name: 'Драконий выдох', description: '-20 ОЗ врагу огнём, накладывает Горение (2)', cost: {om: 30} }] },
    ...
    { name: 'Инсектоиды', passiveBonuses: [], activeAbilities: [{ name: 'Кислотный укус', description: '-10 ОЗ и яд -3/ход', cost: {od: 10, om: 10} }] },
    ...
    { name: 'Карлики', passiveBonuses: [], activeAbilities: [{ name: 'Молот правды', description: 'пробивает щит и наносит 15 урона', cost: {od: 30} }] },
    { name: 'Кентавры', passiveBonuses: ['Скидка на ОД (5)'], activeAbilities: [{ name: 'Копытный разгон', description: 'нанести урон и отступить', cost: {od: 20} }] },
    { name: 'Кицунэ', passiveBonuses: [], activeAbilities: [{ name: 'Иллюзия хвостов', description: 'дезориентация врага', cost: {om: 30} }] },
    { name: 'Коралиты', passiveBonuses: [], activeAbilities: [{ name: 'Всплеск солёной воды', description: 'обезоруживает на 1 ход', cost: {om: 10} }] },
    { name: 'Кордеи', passiveBonuses: ['+50 ОЗ'], activeAbilities: [{ name: 'Пылающая кровь', description: '-10 ОЗ врагу при атаке в ближнем бою', cost: {oz: 5} }] },
    ...
    { name: 'Лартисты', passiveBonuses: [], activeAbilities: [{ name: 'Мир красок', description: 'вводит врага в иллюзию (-действие)', cost: {om: 30} }] },
    ...
    { name: 'Миканиды', passiveBonuses: [], activeAbilities: [{ name: 'Споры восстановления', description: '+10 ОЗ всем в зоне 5м', cost: {om: 30} }] },
    { name: 'Мириоды', passiveBonuses: [], activeAbilities: [{ name: 'Кислотное дыхание', description: '-10 ОЗ, игнорирует броню', cost: {om: 10} }] },
    { name: 'Нарраторы', passiveBonuses: [], activeAbilities: [{ name: 'Печать Слова', description: 'враг не может повторить последнее заклинание', cost: {om: 30} }] },
    { name: 'Неземные', passiveBonuses: [], activeAbilities: [{ name: 'Ментальное прикосновение', description: 'восстановление +15 ОЗ', cost: {om: 10} }] },
    { name: 'Неониды', passiveBonuses: [], activeAbilities: [{ name: 'Фосфоресцирующий всплеск', description: 'ослепление врагов', cost: {om: 10} }] },
    { name: 'Нетленные', passiveBonuses: ['+50 ОЗ'], activeAbilities: [{ name: 'Желеобразный барьер', description: 'поглощает 15 урона', cost: {om: 30} }] },
    ...
    { name: 'Огненные крыланы', passiveBonuses: [], activeAbilities: [{ name: 'Крылья Пламени', description: 'атака по всем врагам в зоне', cost: {om: 30} }] },
    { name: 'Оприты', passiveBonuses: [], activeAbilities: [{ name: 'Разряд', description: '-10 ОЗ и -5 ОМ врагу', cost: {om: 10} }] },
    { name: 'Орк', passiveBonuses: ['Расовая ярость (+10 к урону)'], activeAbilities: [] },
    { name: 'Пересмешники', passiveBonuses: ['+3 к восстановлению ОМ при укусе'], activeAbilities: [{ name: 'Имитация', description: 'доступны все бонусные действия других рас', cost: {om: 90} }] },
    ...
    { name: 'Полузаи', passiveBonuses: ['Иммунитет к огню'], activeAbilities: [{ name: 'Прыжок Зайца', description: 'уворот + перемещение', cost: {od: 15} }] },
    { name: 'Проклятые', passiveBonuses: [], activeAbilities: [{ name: 'Извержение Скверны', description: 'массовый урон по всем', cost: {om: 90, oz: 50} }] },
    { name: 'Псилаты', passiveBonuses: [], activeAbilities: [{ name: 'Психошок', description: 'спутанность действий врага', cost: {om: 30} }] },
    { name: 'Рариты', passiveBonuses: ['+10 ОМ/ход'], activeAbilities: [{ name: 'Каменное касание', description: '-15 ОЗ, шанс паралича', cost: {om: 10} }] },
    { name: 'Саламандры', passiveBonuses: ['Иммунитет к холоду'], activeAbilities: [{ name: 'Пламенный след', description: '-10 ОЗ всем на клетке', cost: {om: 10} }] },
    { name: 'Светоликие', passiveBonuses: [], activeAbilities: [{ name: 'Вспышка Света', description: 'ослепление врагов', cost: {om: 30} }] },
    { name: 'Сирены', passiveBonuses: [], activeAbilities: [{ name: 'Песнь чар', description: 'транс на 1 ход', cost: {om: 30} }] },
    ...
    { name: 'Снежные эльфы', passiveBonuses: [], activeAbilities: [{ name: 'Ледяной вихрь', description: '-15 ОЗ, замедление', cost: {om: 30} }] },
    { name: 'Солнечные эльфы', passiveBonuses: [], activeAbilities: [{ name: 'Луч истины', description: 'раскрытие маскировки, урон светом', cost: {om: 10} }] },
    ...
    { name: 'Тени', passiveBonuses: [], activeAbilities: [{ name: 'Теневой шаг', description: 'перемещение без траты ОД', cost: {om: 10} }] },
    { name: 'Тритоны', passiveBonuses: [], activeAbilities: [{ name: 'Призыв боли', description: 'враг теряет 10 ОЗ/ход 3 хода', cost: {om: 30} }] },
    ...
    { name: 'Цынаре', passiveBonuses: [], activeAbilities: [{ name: 'Гипноз', description: 'враг теряет ход', cooldown: 5, cost: {om: 90} }] },
    { name: 'Энергетические вампиры', passiveBonuses: [], activeAbilities: [{ name: 'Похищение энергии', description: '+10 ОМ, -10 ОМ у врага', cooldown: 2, cost: {om: 10} }] },
    { name: 'Ятанаги', passiveBonuses: ['Невосприимчивы к боли и смертельному урону'], activeAbilities: [{ name: 'Кровавое жжение', description: 'вызывает зуд, -5 ОД и -5 ОЗ', cost: {oz: 5, od: 5} }] },
    { name: 'Куклы', passiveBonuses: ['Невосприимчивы к боли и смертельному урону', 'Штраф к заклинаниям опустошения резерва (20 ОМ)'], activeAbilities: [{ name: 'Прокол иглой', description: 'переносит эффект на другого', cost: {om: 90} }] },
    { name: 'Призраки', passiveBonuses: ['Невосприимчивы к боли и смертельному урону'], activeAbilities: [{ name: 'Призрачный вой', description: 'враг теряет 1 действие', cost: {om: 30} }] },
    { name: 'Скелеты', passiveBonuses: ['+50 ОЗ', 'Невосприимчивы к боли и смертельному урону'], activeAbilities: [{ name: 'Костяной шквал', description: 'массовый урон в ближнем бою', cost: {od: 30} }] },
    { name: 'Жнецы', passiveBonuses: ['+50 ОЗ', 'Невосприимчивы к боли и смертельному урону'], activeAbilities: [{ name: 'Коса конца', description: 'мгновенно снимает все очки ОЗ', cost: {om: 90} }] },
    { name: 'Духи', passiveBonuses: ['Невосприимчивы к боли и смертельному урону'], activeAbilities: [{ name: 'Эфирный крик', description: '-10 ОМ врагу, при наличии духовной связи', cost: {om: 30} }] },
];
