...
export const RACES: Race[] = [
    ...
    { name: 'Ларимы', passiveBonuses: ['Поглощение входящего магического урона'], activeAbilities: [] },
    ...
    { name: 'Призраки', passiveBonuses: ['Эфирная форма (иммунитет к физическим атакам)', 'Ясновидение (враг теряет 5 ОМ/ход)'], activeAbilities: [{ name: 'Страх из-за занавеси', description: 'лишает врага одного действия и наносит 20 урона.', cost: { om: 30 } }] },
