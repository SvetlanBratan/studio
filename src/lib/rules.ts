...
export const RACES: Race[] = [
    ...
    { name: 'Василиски', passiveBonuses: ['Ядовитый урон -10 при укусе'], activeAbilities: [{ name: 'Окаменение взглядом', description: 'враг теряет ход', cooldown: 5, cost: {om: 90} }] },
    ...
    { name: 'Драконы', passiveBonuses: ['+5 урона магией', '+10 ОМ/ход', '+50 ОЗ (раз за бой)'], activeAbilities: [{ name: 'Драконий выдох', description: '-20 ОЗ врагу огнём, накладывает Горение (2)', cost: {om: 30} }] },
    ...
    { name: 'Цынаре', passiveBonuses: ['Сопротивление к колющему и режущему'], activeAbilities: [{ name: 'Гипноз', description: 'враг теряет ход', cooldown: 5, cost: {om: 90} }] },
    { name: 'Энергетические вампиры', passiveBonuses: ['Иммунитет к ко всем действиям'], activeAbilities: [{ name: 'Похищение энергии', description: '+10 ОМ, -10 ОМ у врага', cooldown: 2, cost: {om: 10} }] },
