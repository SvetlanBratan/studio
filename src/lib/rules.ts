...
export const RACES: Race[] = [
    ...
    { name: 'Кордеи', passiveBonuses: ['+50 ОЗ (раз за бой)'], activeAbilities: [{ name: 'Пылающая кровь', description: '-10 ОЗ врагу при атаке в ближнем бою', cost: {oz: 5} }] },
    ...
    { name: 'Нетленные', passiveBonuses: [], activeAbilities: [{ name: 'Желеобразный барьер', description: 'поглощает 15 урона', cost: {om: 30} }] },
    ...
    { name: 'Скелеты', passiveBonuses: ['Невосприимчивы к боли и смертельному урону'], activeAbilities: [{ name: 'Костяной шквал', description: 'массовый урон в ближнем бою', cost: {od: 30} }] },
    { name: 'Жнецы', passiveBonuses: ['Невосприимчивы к боли и смертельному урону'], activeAbilities: [{ name: 'Коса конца', description: 'мгновенно снимает все очки ОЗ', cost: {om: 90} }] },
