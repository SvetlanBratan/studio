...
export const RACES: Race[] = [
    ...
    { name: 'Дарнатиаре', passiveBonuses: ['+2 исцеления/ход'], activeAbilities: [{ name: 'Целительный ветер', description: '+15 ОЗ союзнику'}] },
    { name: 'Джакали', passiveBonuses: ['+10 ОМ/ОЗ при религиозных ритуалах'], activeAbilities: [{ name: 'Благословение крови', description: '+20 ОЗ союзнику, при молитве'}] },
    ...
    { name: 'Драконы', passiveBonuses: ['+5 урона магией, +10 ОМ/ход'], activeAbilities: [{ name: 'Драконий выдох', description: '-20 ОЗ врагу огнём/льдом/кислотой'}] },
    { name: 'Дриады', passiveBonuses: ['+3 исцеления при природе'], activeAbilities: [{ name: 'Корнеплетение', description: 'обездвиживание врага', cooldown: 4}] },
    { name: 'Дриды', passiveBonuses: ['+2 ОЗ при контакте с цветами'], activeAbilities: [{ name: 'Цветочный нектар', description: '+10 ОЗ и +5 ОМ'}] },
    { name: 'Дроу', passiveBonuses: ['+4 урона/ход ночью'], activeAbilities: [{ name: 'Теневая стрела', description: '-15 ОЗ, +5 к уклонению'}] },
    { name: 'Инсектоиды', passiveBonuses: ['Шанс отравить врага (15%)'], activeAbilities: [{ name: 'Кислотный укус', description: '-10 ОЗ и яд -3/ход'}] },
    { name: 'Ир Эйн', passiveBonuses: ['+2 ОМ/ход в группе'], activeAbilities: [{ name: 'Пивной рев', description: 'деморализация врага (-ОД)'}] },
    { name: 'Ихо', passiveBonuses: ['+2 ОМ/ход'], activeAbilities: [{ name: 'Лозунг крови', description: '+10 ОМ союзникам рядом'}] },
    { name: 'Карлики', passiveBonuses: ['+5 к броне'], activeAbilities: [{ name: 'Молот правды', description: 'пробивает щит и наносит 15 урона'}] },
    { name: 'Кентавры', passiveBonuses: ['+15 ОД в поле'], activeAbilities: [{ name: 'Копытный разгон', description: 'нанести урон и отступить'}] },
    { name: 'Кицунэ', passiveBonuses: ['+2 ОМ за каждые 3 хвоста'], activeAbilities: [{ name: 'Иллюзия хвостов', description: 'дезориентация врага'}] },
    { name: 'Коралиты', passiveBonuses: ['+10 к сопротивлению'], activeAbilities: [{ name: 'Всплеск солёной воды', description: 'обезоруживает на 1 ход'}] },
    { name: 'Кордеи', passiveBonuses: ['+10 ОЗ в лесной местности'], activeAbilities: [{ name: 'Пылающая кровь', description: '-10 ОЗ врагу при атаке в ближнем бою'}] },
    { name: 'Кунари', passiveBonuses: ['невосприимчивость ко всем видам урона, кроме плетельщиц'], activeAbilities: [{ name: 'Зов леса', description: '+10 ОЗ всей группе'}] },
    { name: 'Ларимы', passiveBonuses: ['-5 ОД у врага при зрительном контакте'], activeAbilities: [{ name: 'Укус', description: '-15 ОЗ, игнорирует щит'}] },
    { name: 'Лартисты', passiveBonuses: ['+10 ОМ при удаче'], activeAbilities: [{ name: 'Мир красок', description: 'вводит врага в иллюзию (-действие)'}] },
    { name: 'Лепреконы', passiveBonuses: ['+10 ОЗ/ход'], activeAbilities: [{ name: 'Клеверная искра', description: '+15 ОЗ и +10 ОМ (1 раз в бой)'}] },
    { name: 'Миканиды', passiveBonuses: ['-5 ОД у врага при предсказании действий'], activeAbilities: [{ name: 'Споры восстановления', description: '+10 ОЗ всем в зоне 5м'}] },
    { name: 'Мириоды', passiveBonuses: ['+5 ОЗ/ОМ союзнику рядом'], activeAbilities: [{ name: 'Кислотное дыхание', description: '-10 ОЗ, игнорирует броню'}] },
    { name: 'Нарраторы', passiveBonuses: ['+10 ОМ при заклинаниях воды'], activeAbilities: [{ name: 'Печать Слова', description: 'враг не может повторить последнее заклинание'}] },
    { name: 'Неземные', passiveBonuses: ['+10 ОЗ, сниженный урон от физических атак'], activeAbilities: [{ name: 'Ментальное прикосновение', description: 'восстановление +15 ОЗ'}] },
    { name: 'Неониды', passiveBonuses: ['+10 ОЗ и ОД в звероформе'], activeAbilities: [{ name: 'Фосфоресцирующий всплеск', description: 'ослепление врагов'}] },
    { name: 'Нетленные', passiveBonuses: ['+5 урона огнём'], activeAbilities: [{ name: 'Желеобразный барьер', description: 'поглощает 15 урона'}] },
    { name: 'Нимфилус', passiveBonuses: ['+10 ОМ, возможен удар током'], activeAbilities: [{ name: 'Сладкое прикосновение', description: '+10 ОЗ и -ОД врагу'}] },
    { name: 'Оборотни', passiveBonuses: ['Иммунитет к иллюзиям'], activeAbilities: [{ name: 'Смена формы', description: 'звериный облик, бонусы к урону'}] },
    { name: 'Огненные крыланы', passiveBonuses: ['-5 ОД у врага рядом'], activeAbilities: [{ name: 'Крылья Пламени', description: 'атака по всем врагам в зоне'}] },
    { name: 'Оприты', passiveBonuses: ['-8 ОЗ/ход врагу и себе'], activeAbilities: [{ name: 'Разряд', description: '-10 ОЗ и -5 ОМ врагу'}] },
    { name: 'Пересмешники', passiveBonuses: ['-5 ОД у врага'], activeAbilities: [{ name: 'Имитация', description: 'доступны все бонусные действия других рас'}] },
    { name: 'Полукоты', passiveBonuses: ['Окаменяющий взгляд при атаке'], activeAbilities: [{ name: 'Мурлыканье', description: 'усыпляет врага на 1 ход'}] },
    { name: 'Полузаи', passiveBonuses: ['+5 урона огнём, иммунитет к огню'], activeAbilities: [{ name: 'Прыжок Зайца', description: 'уворот + перемещение'}] },
    { name: 'Проклятые', passiveBonuses: ['+5 ОМ при светлых заклинаниях'], activeAbilities: [{ name: 'Извержение Скверны', description: 'массовый урон по всем'}] },
    { name: 'Псилаты', passiveBonuses: ['-5 ОД у врага рядом'], activeAbilities: [{ name: 'Психошок', description: 'спутанность действий врага'}] },
    { name: 'Рариты', passiveBonuses: ['+10 ОЗ/ход'], activeAbilities: [{ name: 'Каменное касание', description: '-15 ОЗ, шанс паралича'}] },
    { name: 'Саламандры', passiveBonuses: ['+5 урона льдом, иммунитет к холоду'], activeAbilities: [{ name: 'Пламенный след', description: '-10 ОЗ всем на клетке'}] },
    { name: 'Светоликие', passiveBonuses: ['+10 ОЗ при дневном свете'], activeAbilities: [{ name: 'Вспышка Света', description: 'ослепление врагов'}] },
    { name: 'Сирены', passiveBonuses: ['+10 ОЗ/щит'], activeAbilities: [{ name: 'Песнь чар', description: 'транс на 1 ход'}] },
    { name: 'Слизни', passiveBonuses: ['Иммунитет к контролю'], activeAbilities: [{ name: 'Склизкий отпор', description: 'враг соскальзывает, теряет действие'}] },
    { name: 'Снежные эльфы', passiveBonuses: ['-5 урона по себе'], activeAbilities: [{ name: 'Ледяной вихрь', description: '-15 ОЗ, замедление'}] },
    { name: 'Солнечные эльфы', passiveBonuses: ['-10 ОЗ/2 хода врагу при укусе'], activeAbilities: [{ name: 'Луч истины', description: 'раскрытие маскировки, урон светом'}] },
    { name: 'Сфинксы', passiveBonuses: ['Незаметность'], activeAbilities: [{ name: 'Загадка Сфинкса', description: '-20 ОЗ'}] },
    { name: 'Тальены', passiveBonuses: ['+10 ОМ, -5 ОЗ/ход'], activeAbilities: [{ name: 'Психостенка', description: 'отражение дебаффов'}] },
    { name: 'Тени', passiveBonuses: ['-5 ОД у врагов рядом'], activeAbilities: [{ name: 'Теневой шаг', description: 'перемещение без траты ОД'}] },
    { name: 'Тритоны', passiveBonuses: ['-8 ОЗ при укусе'], activeAbilities: [{ name: 'Призыв боли', description: 'враг теряет 10 ОЗ/ход 3 хода'}] },
    { name: 'Хамелеоны', passiveBonuses: ['Иммунитет к боли и страху'], activeAbilities: [{ name: 'Маскировка', description: '+50% уворота на 1 ход'}] },
    { name: 'Химеры', passiveBonuses: ['Игнорируют физ. урон'], activeAbilities: [{ name: 'Мутация', description: 'временно копирует черты другой расы'}] },
    { name: 'Цынаре', passiveBonuses: ['Сопротивление к колющему и режущему'], activeAbilities: [{ name: 'Гипноз', description: 'враг теряет ход'}] },
